...
module.exports = [
  ...
  "(Pick 2) Rumor has it that Vladimir Putin's favorite delicacy is _____ stuffed with _____."
  "(Pick 2) Lifetime&reg; presents _____, the story of _____."
  "Make a haiku.",
  ...
  "2 AM in the city that never sleeps. The door swings open and _she_ walks in, legs up to here. Something in her eyes tells me she's looking for _____.",
  "As king, how will I keep the peasants in line?",
  "(Pick 2) Oprah's book of the month is \"_____ For _____: A Story of Hope.\""
  "Do _not_ fuck with me! I am literally _____ right now.",
  ...
  "(Pick 2) Every step towards _____ gets me a little closer to _____."
  ...
  "(Pick 2) Heed my voice, mortals! I am the god of _____, and I will not tolerate _____!"
  ...
  "(Pick 2) Well if _____ is good enough for _____, it's good enough for me."
  ...
  "(Pick 2) In line with our predictions, we find a robust correlation between _____ and _____ (p&gt;.05)."
  ...
  "(Pick 2) In an attempt to recreate conditions just after the Big Bang, physicists at the LHC are observing collisions between _____ and _____."
  ...
  "(Pick 2) Today on MythBusters, we found out how long _____ can withstand _____."
  ...
  "Don't miss Rachel Ray's hit new show, _Cooking with ______.",
  "Excuse me, waiter. Could take this back? This soup tastes like _____.",
  "Now on Netflix: _Jiro Dreams of ______.",
]
